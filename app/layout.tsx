...
export const metadata: Metadata = {
  title: '断食Lab',
  description: '断食・ファスティング情報',
  openGraph: { title: '断食Lab', description: '断食・ファスティング情報', type: 'website', locale: 'ja_JP', siteName: '断食Lab' },
  twitter: { card: 'summary_large_image', title: '断食Lab', description: '断食・ファスティング情報' },
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "断食Lab", "description": "断食・ファスティング情報", "url": "https://intermittent-fasting-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}
